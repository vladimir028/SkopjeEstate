namespace RealEstateProject.Migrations
{
    ...
    public partial class init : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Properties", "Owner_Id", "dbo.AspNetUsers");
            DropForeignKey("dbo.Properties", "Agent_Id", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUsers", "Agency_Id", "dbo.Agencies");
            ...
            DropIndex("dbo.AspNetUsers", new[] { "Agency_Id" });
